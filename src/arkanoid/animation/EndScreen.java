...
public class EndScreen implements Animation {
    ...
    private Counter remindingLives;
     ...
     * @param remindingLives the number we want to count from.
     * @param currentScore the sprite collection of the game.
     * */
    public EndScreen(KeyboardSensor keyboardSensor, Counter remindingLives, Counter currentScore) {
        this.keyboardSensor = keyboardSensor;
        this.stop = false;
        this.remindingLives = remindingLives;
    ...
    public void doOneFrame(DrawSurface d) {
        ...
        if (this.remindingLives.getValue() == 0) {
